...
2. **IMPORTANT**: Click this link: [Regression Challenge Sign Up](https://www.kaggle.com/t/673ffd8c6d61457fab8e3d88a665499c) to **join** the competition (otherwise you will not be able to make submissions!)
...
- Presentation slides must be submitted by 9AM ET on the presentation date. 
- Your technical report must be submitted in your submission repository by 9PM ET on the due date.
- The Kaggle competition will close at 9PM ET on the due date.
